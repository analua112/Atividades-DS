...
#INPUT
    #PERFUME 1
     self.__nome = input("Digite o nome do produto: ")
        self.__fragrancia = input("Digite a fragrância: ")
        self.__volume = float(input("Digite o volume (em ml): "))
        self.__preco = int(input("Digite o preço: "))
        self.__dataFabricacao = int(input("Digite a data de fabricação: ")
        self.__embalagem = input("Digite o tipo de embalagem: ")
